...
public class BoardPanel extends JPanel {
    ...
    private static boolean isSessionWrote = false;
    ...
    public BoardPanel(SnakeGame game) {
        ...
        AskUsername askUsername = new AskUsername();




        JTextField askUsernameField = askUsername.addAskUsername(game);




        this.add(askUsernameField);


        BoardPanel current = this;


        KeyListener askingUsernameKeyListener = new KeyListener() {
            @Override
        ...
        askUsernameField.addKeyListener(askingUsernameKeyListener);
    ...
    public void clearBoard() {
        saveSession.setSessionWrote(false);
    ...
    public void paintComponent(Graphics g) {
        ...
        if(game.isGameOver() || game.isNewGame() || game.isPaused()) {
            ...
            if(game.isNewGame()) {
                ...
                largeMessage = "Игра окончена! " + getUsername();
                smallMessage = "Нажмите Enter, чтобы начать заново";

//              AskUsername askUsername = new AskUsername();
//              askUsername.writeSession(game.getScore(), getUsername());


                if(!isSessionWrote){
                   saveSession.saveSession(getUsername(), game.getScore());
                   saveSession.setSessionWrote(true);
                }
                ...
                largeMessage = "Приостановлено";
                smallMessage = "Нажмите P для возобновления";
            }
